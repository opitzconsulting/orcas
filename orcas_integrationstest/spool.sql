...
BEGIN
  ...
  FOR REC IN (SELECT TABLE_NAME, COLUMN_NAME FROM USER_TAB_COLUMNS WHERE TABLE_NAME NOT LIKE 'BIN$%' AND TABLE_NAME NOT LIKE '%$%'  AND DATA_TYPE NOT LIKE 'BLOB' AND DATA_TYPE NOT LIKE 'NCLOB' AND DATA_TYPE NOT LIKE 'CLOB' AND DATA_TYPE NOT LIKE 'XMLTYPE' AND DATA_TYPE NOT LIKE 'LONG' AND DATA_TYPE NOT LIKE 'LONG RAW' ORDER BY TABLE_NAME ASC, COLUMN_NAME ASC)
  LOOP
