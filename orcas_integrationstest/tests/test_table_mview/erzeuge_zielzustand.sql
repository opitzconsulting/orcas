...
create materialized view tab_mod_mview_column on prebuilt table refresh complete on demand enable query rewrite as select col_add_ix_1, col_add_ix_2 from tab_view;
