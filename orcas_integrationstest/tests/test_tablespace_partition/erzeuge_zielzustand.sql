...
(
  ...
  partition part_2 values (2) tablespace &1,
  partition part_3 values (default) tablespace &1
);
...
(
  ...
  partition part_2 values less than (maxvalue) tablespace &1
);
