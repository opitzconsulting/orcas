...
create table tab_d
(
    "tab d id"	                NUMERIC(9) constraint pk_tab_d primary key not null
);
...
( 	
    tab_index_test_id	NUMERIC(9)   not null,
...
(
	...
	constraint fk_tab_index_test_ref_a_id foreign key (tab_a_id) references tab_index_test (tab_index_test_id) on delete cascade
);
