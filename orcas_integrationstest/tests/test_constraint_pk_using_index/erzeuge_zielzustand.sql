...
create unique index tab_wrong_pk_and_wrong_ix_ix on tab_wrong_pk_and_wrong_ix (id1);

alter table tab_wrong_pk_and_wrong_ix add constraint tab_wrong_pk_and_wrong_ix_pk primary key (id1) using index tab_wrong_pk_and_wrong_ix_ix;
