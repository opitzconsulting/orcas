...
public class GraphForSingleTable extends Graph
{
  ...
  public GraphForSingleTable( Table pSingleTable, List<Graph> pParentGraphs, Styles pStyles, Tableregistry pTableregistry )
  {
    super( pParentGraphs, pStyles, pTableregistry );
