...
public class JavaOdGenerator extends JavaGenerator
{
  ...
  public void export()
  {
    ...
    {
      writeJavaFile( lClassDataType.getDiffJavaName() + ".java", p -> _writeDiffClass( lClassDataType, lTypeDataContainer, p ) );
    }
    ...
    for( ClassDataType lClassDataType : lNoneEnumTypes )
    {
      writeJavaFile( lClassDataType.getMergeJavaName() + ".java", p -> _writeMergeClass( lClassDataType, lTypeDataContainer, p, lOmTypes.contains( lClassDataType ) ) );
    }

    writeJavaFile( "DiffRepository.java", p -> _writeDiffRepository( lNoneEnumTypes, lTypeDataContainer, p ) );
  }
  ...
  private void _writeDiffClass( ClassDataType pClassDataType, TypeDataContainer pTypeDataContainer, JavaPrettyWriter pOut )
  {
    ...
    if( pClassDataType.getSuperclass() == null )
    {
      ...
      pOut.println( "public " + "boolean isRecreateNeeded;" );
    }
