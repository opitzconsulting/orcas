alter table TAB_WRONG_UK_NAME drop index TAB_WRONG_UK_NAME_WRONG;
alter table TAB_WRONG_UK_NAME add constraint TAB_WRONG_UK_NAME unique (ID);
alter table TAB_WRONG_UK_COLUMNS drop index TAB_WRONG_UK_COLUMN;
alter table TAB_WRONG_UK_COLUMNS add constraint TAB_WRONG_UK_COLUMN unique (ID1,ID2);
alter table TAB_WRONG_UK_COLUMN_ORDER drop index TAB_WRONG_UK_COLUMN_ORDER;
