...
-- ignore-additionsonly: alter table TAB_MOD drop (OLD_COL);
...
-- ignore-additionsonly: create unique index TAB_MOD_IX_ADD_UNIQUE on TAB_MOD ( COL_2 ) parallel;
-- ignore-additionsonly: alter index TAB_MOD_IX_ADD_UNIQUE noparallel;
