drop table TAB_OLD;
create table TAB_NEW (  ID1 NUMERIC(15) not null, ID2 NUMERIC(20) not null   )  ;
alter table TAB_NEW add constraint TAB_NEW_UK unique (ID1,ID2);
alter table TAB_MOD drop index TAB_MOD_UK;
alter table TAB_MOD drop index TAB_MOD_UK_OLD_COL;
alter table TAB_MOD drop index TAB_MOD_UK_OLD_COMB;
