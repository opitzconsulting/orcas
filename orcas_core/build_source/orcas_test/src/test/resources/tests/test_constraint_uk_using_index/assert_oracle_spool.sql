...
create unique index TAB_NEW_IX on TAB_NEW_UK ( ID1,ID2 ) parallel;
...
create unique index TAB_MOD_IX on TAB_MOD_UK ( ID1,ID2 ) parallel;
alter index TAB_MOD_IX noparallel;
