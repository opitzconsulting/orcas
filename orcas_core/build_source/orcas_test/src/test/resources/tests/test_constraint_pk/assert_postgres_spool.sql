...
create table TAB_NONAME_PK (  ID1 NUMERIC(15) not null   )  ;
alter table TAB_NONAME_PK add primary key (ID1);
create table TAB_CREATE_TAB_NAMED_PK (  ID1 NUMERIC(15) not null   )  ;
alter table TAB_CREATE_TAB_NAMED_PK add constraint PK_NAME primary key (ID1);
create table TAB_NEW_PK_STRING (  "id string" NUMERIC(15) not null   )  ;
